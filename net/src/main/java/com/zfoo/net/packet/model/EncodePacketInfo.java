...
public class EncodePacketInfo {
    ...
    public static EncodePacketInfo valueOf(IPacket packet, @Nullable IPacketAttachment packetAttachment) {
        EncodePacketInfo packetInfo = new EncodePacketInfo();
