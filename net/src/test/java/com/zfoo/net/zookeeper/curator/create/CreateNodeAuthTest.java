...
public class CreateNodeAuthTest {
    ...
    public void createTest() throws Exception {
        ...
        ACL aclDigest = new ACL(Perms.READ | Perms.WRITE, new Id("digest", DigestAuthenticationProvider.generateDigest("islandempty:123456")));
    ...
    public void getDataWithAuthTest() throws Exception {
        ...
        CuratorFramework curator = CuratorFrameworkFactory
                ...
                .connectString("localhost:2181")
                .sessionTimeoutMs(5000)
                .authorization("digest", "islandempty:123456".getBytes()) // 授权访问
                .connectionTimeoutMs(5000)
                .retryPolicy(retryPolicy)
                .build();
