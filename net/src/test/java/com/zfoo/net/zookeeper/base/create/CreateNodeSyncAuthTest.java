...
public class CreateNodeSyncAuthTest {
    ...
    public void generateDigestTest() throws NoSuchAlgorithmException {
        String digest = DigestAuthenticationProvider.generateDigest("islandempty:123456");
    ...
    static class CreateNodeSyncAuthWatcher implements Watcher {
        ...
        private void doSomething() {
            try {
                ...
                ACL aclDigest = new ACL(Perms.READ | Perms.WRITE, new Id("digest", DigestAuthenticationProvider.generateDigest("islandempty:123456")));// 用户名+密码
            ...
            try {
                ...
                zookeeper.addAuthInfo("digest", "islandempty:123456".getBytes());
                zookeeper.getData("/node_test", false, stat);
                somethingDone = true;
            } catch (Exception e) {
                e.printStackTrace();
